...
python3 wca_solvation_forward_bound.py \
    ...
    -data_baseglob "forward_*.txt" > "./forward_bound/data_τ_0.25.log"
python3 wca_solvation_forward_bound.py \
