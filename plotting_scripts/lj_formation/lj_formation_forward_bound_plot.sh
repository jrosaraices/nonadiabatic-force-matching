...
python3 lj_formation_forward_bound_plot.py \
    -data_files \
        ...
        "../../post-processing_scripts/lj_formation/forward_bound/data_τ_0.20.log" \
        "../../post-processing_scripts/lj_formation/forward_bound/data_τ_0.50.log" \
